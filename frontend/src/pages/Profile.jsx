            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="flex gap-20 mt-2">
                <div className="bg-gray-400 py-4 px-10 rounded flex flex-col items-center">
                  ...
                  <span className="text-3xl font-bold" style={{ fontFamily: "'Jersey 20', sans-serif" }}>0</span>
                </div>
                <div className="bg-gray-400 p-4 rounded flex flex-col items-center">
                  <span className="text-sm">Level:</span>
                  <span className="text-2xl font-bold" style={{ fontFamily: "'Jersey 20', sans-serif" }}>beruang bayi</span>
                </div>
              </div>
